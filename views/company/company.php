  ...
  <div class="card-header">
    <div class="row">
      ...
      <div class="col-md-6 text-right">
        <button class="btn btn-success" onclick="location.href='company_create.php';">Create new</button>
        ...
        <tbody>
              <?php foreach ($result as $row) : ?>
                  <tr id="<?php echo ($row["com_id"]); ?>">
                    ...
                    <td class="text-center"><a href="company_change.php?id=<?php echo base64_encode($row["com_id"]); ?>" class="btn btn-outline-warning btn-sm"><span class="fas fa-edit fa-fw"></span></a> 
                    <!-- <a id="button"  href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='company_delete.php?id=<?php echo base64_encode($row["com_id"]);?>';}"  class="btn btn-outline-danger btn-sm"><span class="fas fa-trash fa-fw"></span></a> -->
