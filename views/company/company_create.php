...
<!-- end card header -->
  <div class="card-body">
    <div class="col-md-12">
                      ...
                      <label for="com_name" class="col-sm-2 col-form-label">ชื่อแผนก : <span class="text-danger">*</span></label>
                      <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                      <label for="com_remark" class="col-sm-2 col-form-label">remark  : <span class="text-danger">*</span></label>
                      <div class="col-sm-8">
                        <input type="text" name="com_remark" id="com_remark" value="" class="form-control" required>
                    </div>
                    </div>
